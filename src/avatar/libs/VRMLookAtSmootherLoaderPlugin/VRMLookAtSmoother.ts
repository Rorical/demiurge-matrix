// https://github.com/pixiv/ChatVRM/blob/main/src/lib/VRMLookAtSmootherLoaderPlugin/VRMLookAtSmoother.ts

import { VRMHumanoid, VRMLookAt, type VRMLookAtApplier } from "@pixiv/three-vrm";
